...
\address{3800 Solano Park Cir Apt 4033}
\address{(209) 200-6897}
...
Software engineering, programming languages, computer security, data mining 
and networking
 
 
\section{EDUCATION}

{\sl B.A.,} Economics with minor in Computer Science\\
% \sl will be bold italic in New Century Schoolbook (or any
% postscript font) and just slanted in Computer Modern
% (default) font
